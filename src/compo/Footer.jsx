      ...
      <div className="holder">
        <div className="footer-wrapper flow">
          <div className="footer-logo">
            <img src={Logo} alt="Huddle" width={200} height={33} />
          </div>
          <div className="footer-body">
            <ul className="footer-contact flow-all">
              ...
              <li className="tel">
                <a href="tel:+15431234567">+15431234567</a>
              </li>
              <li className="email">
        ...
        <div className="copyright">&copy; Copyright 2023 Huddle. All rights reserved.</div>
      </div>
    </>
  );
};
